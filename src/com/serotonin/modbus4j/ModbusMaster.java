...
abstract public class ModbusMaster extends Modbus {
     ...
     * @throws com.serotonin.modbus4j.exception.ModbusTransportException if there was an IO error or other technical failure while sending the message
     * @throws com.serotonin.modbus4j.exception.ErrorResponseException   if the response returned from the slave was an exception.
     */
